...
HD_0158_RG0019A::HD_0158_RG0019A(int8_t n_panel,
                                 int8_t pin_a3, int8_t pin_a2, int8_t pin_a1, int8_t pin_a0,
                                 int8_t pin_dg, int8_t pin_clk, int8_t pin_we, int8_t pin_dr, int8_t pin_ale) : Panel_Device(),
                                                                                                                pinA3(pin_a3),
                                                                                                                pinA2(pin_a2),
                                                                                                                pinA1(pin_a1),
                                                                                                                pinA0(pin_a0),
...
void HD_0158_RG0019A::drawPixel(int16_t x, int16_t y, uint32_t color) {
  startWrite();
...
void HD_0158_RG0019A::writePixel(int16_t x, int16_t y, uint32_t color) {
  ...
  switch (lgfx::v1::getSwap24(color)) {
    case DOT_RED:
      bufferR[i] |= 1 << panelX;
      bufferG[i] &= ~(1 << panelX);
      break;
